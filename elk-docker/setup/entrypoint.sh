...
users_passwords=(
	[logstash_internal]="${LOGSTASH_INTERNAL_PASSWORD:-"123456"}"
	[kibana_system]="${KIBANA_SYSTEM_PASSWORD:-"123456"}"
	[metricbeat_internal]="${METRICBEAT_INTERNAL_PASSWORD:-"123456"}"
	[filebeat_internal]="${FILEBEAT_INTERNAL_PASSWORD:-"123456"}"
	[heartbeat_internal]="${HEARTBEAT_INTERNAL_PASSWORD:-"123456"}"
	[monitoring_internal]="${MONITORING_INTERNAL_PASSWORD:-"123456"}"
	[beats_system]="${BEATS_SYSTEM_PASSWORD:-"123456"}"
)
